  ...
  private void generatePassword(int longitud) {
    ...
    for(int i = 1; i <= longitud; i++){
      ...
      if (aleatoryNumber <= 9) {
        ...
        contraseña = contraseña + Character.toString((char) (aleatoryNumber + 48));
      } else if (aleatoryNumber > 9 && aleatoryNumber <= 35) {
        contraseña = contraseña + Character.toString((char) (aleatoryNumber + 55));
      } else if (aleatoryNumber > 35 && aleatoryNumber <= 61) {
        contraseña = contraseña + Character.toString((char) (aleatoryNumber + 61));
      }    
    }
  }
